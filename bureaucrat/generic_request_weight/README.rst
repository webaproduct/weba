...
Generic Request SLA is a module of the Generic Request application.

The module allows you to automatically sort requests by predefined rules depending on SLA, Priority, Kanban State, Request Type, etc.
