Generic Request Condition Service
=================================
...
Generic Request (Mail Conditions) module provides predefined conditions that could be used in automation to easily handle request's mail events.
