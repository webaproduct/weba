Generic Request Action Project
==============================
...
This module provides integration between the Generic Request Action and Generic Request Project applications. Now project tasks can be created using automated actions.
