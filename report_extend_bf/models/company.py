...
class Company(models.Model):
    ...
    # vat_label = fields.Char(related='account_fiscal_country_id.vat_label') Campo se debe mover al modulo de report_extend_bf_account_base
    # Remover los siguientes 02 campos para la version 16.0
