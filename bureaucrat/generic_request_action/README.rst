...
Generic Request (Actions) is a module of the Generic Request application. It allows you to assign actions that will be performed when the request moves along the route.
