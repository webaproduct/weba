...
class TestRequestEvents(ReduceLoggingMixin, TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.subrequest1_route_1_2 = cls.env.ref(
            'generic_request.request_stage_route_type_access_new_to_sent')
    ...
    def test_request_event(self):
        ...
        self.assertEqual(
            event[0].subrequest_route_id, self.subrequest1_route_1_2)
        self.assertEqual(
