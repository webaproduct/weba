...
With this module, you can assign the Generic Team to specific Generic Service.
This way, it would be possible to use it in Generic Assignments,
for case, when you need to assign request to the team responsible for specific service.
