...
This module provides integration between the Generic Request Action and Generic Request survey applications. Now surveys can be sent using automated actions.
